...
var flags = map[string]*flagData{
	...
	"parent_map_pre":    {description: "prework for mapping names to their parent domains", function: mapZoneParentsPre},
	"parent_map":        {description: "map names to their parent domains", function: mapZoneParents},
...
var (
	flagOrder = []string{
		...
		"axfr", "psl", "validate", "parent_map_pre", "parent_map", "parent_ns",
