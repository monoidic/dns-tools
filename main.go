...
var flags = map[string]*flagData{
	...
	"rr_ns":        {description: "extract zone-ns relations from parsed RRs", function: zoneNsFromRR},
	"rr_ip":        {description: "extract name-ip relations from parsed RRs", function: nsIPFromRR},
	"rr_mx":        {description: "extract name-mx relations from parsed RRs", function: zoneMXFromRR},
